...
const rows = [
    createData(1, 'Habitación 1', 65000, 5),
    createData(2, 'Habitación 2', 65000, 4),
    createData(3, 'Habitación 3', 65000, 2),
    createData(4, 'Habitación 4', 65000, 2),
    createData(5, 'Habitación 5', 65000, 3),
];
...
export default function Tarifas() {
    ...
    return (
        <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
            ...
            >
                <Paper sx={{ width: { xs: '97%', sm: '100%', md: '100%', xl: '100%' }, mb: 2 }}>
                    <Box sx={{ display: 'inline-block', p: 2, marginLeft: { xs: '65%', xl: '90%' } }}>
                        <ConfirmacionTarifas />
                    </Box>
